...
//
// This is the app's ONLY accessibility gate that runs code (`@axe-core/react` is deliberately
// absent — see `src/main.tsx`), so it carries more weight here than in the Next apps.
