 ...
 *  (callers above callees, containers above what they contain), not as a random force-directed
 *  cloud. Runs once per data change, not continuously (dagre is a one-shot layout, not a physics
 *  simulation). */
