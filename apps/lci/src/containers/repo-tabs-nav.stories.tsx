// The Overview/Feedback/Graph/Settings tab strip for one repository, on `ui-web`'s `SubNav` (the
...
export const Feedback: Story = { decorators: [withPathname('/repositories/1/feedback')] };
