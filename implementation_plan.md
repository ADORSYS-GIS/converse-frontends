...
- **Project membership:** confirmed with the backend that there is *no* project-level membership — members/owners are defined only at the Account level. No project-members UI is needed; account members remain managed in Account Settings.
