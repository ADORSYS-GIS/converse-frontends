    ...
    translation: {
      ...
      usage: {
        ...
        scope: {
          ...
          apiKey: 'API key',
          user: 'User',
          selectApiKeyLabel: 'API key',
          selectApiKeyPrompt: 'Select an API key to view its usage.',
          noApiKeys: 'This project has no API keys yet.',
          selectApiKeyNamed: 'View usage for {{name}}',
        },
