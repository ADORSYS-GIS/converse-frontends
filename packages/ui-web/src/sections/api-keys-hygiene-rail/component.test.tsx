...
describe('ApiKeysHygieneRail', () => {
  ...
  it('renders nothing at all when every count is zero', () => {
    const { container } = render(<ApiKeysHygieneRail hygiene={apiKeysCleanHygiene} />);
