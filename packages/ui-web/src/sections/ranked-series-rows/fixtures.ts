...
export const rankedRowsEstateAccounts: RankedSeriesRow[] = [
  {
    ...
    label: 'nova-labs',
    value: 812.4,
    formattedValue: '$812.40',
    delta: 42.1,
    formattedDelta: '$42.10',
    sparklinePoints: [600, 650, 700, 690, 750, 780, 800, 812],
  },
  {
    key: 'acct_2',
    label: 'brightline',
    value: 401.2,
    formattedValue: '$401.20',
    delta: -18.4,
    formattedDelta: '$18.40',
    sparklinePoints: [420, 415, 410, 405, 402, 400, 401, 401],
  },
  {
    key: 'acct_3',
    label: 'summit-analytics',
    value: 220.5,
    formattedValue: '$220.50',
    delta: 5.2,
    formattedDelta: '$5.20',
    sparklinePoints: [200, 205, 210, 212, 215, 218, 219, 220],
  },
  {
    key: 'acct_4',
    label: 'wharf-systems',
    ...
    delta: 0,
    formattedDelta: '$0.00',
    sparklinePoints: [118, 118, 118, 118, 118, 118, 118, 118],
  },
  {
    key: 'acct_5',
    label: 'clearwater',
    value: 96.3,
    formattedValue: '$96.30',
    delta: -2.1,
    formattedDelta: '$2.10',
    sparklinePoints: [98, 97, 96, 96, 96, 96, 96, 96],
  },
  {
    key: 'acct_6',
    label: 'north-star',
    value: 71.8,
    formattedValue: '$71.80',
    delta: 11.4,
    formattedDelta: '$11.40',
    sparklinePoints: [50, 55, 60, 62, 65, 68, 70, 72],
  },
  {
    key: 'acct_7',
    label: 'redline-ops',
    value: 44.2,
    formattedValue: '$44.20',
    delta: -1.0,
    formattedDelta: '$1.00',
    sparklinePoints: [45, 45, 44, 44, 44, 44, 44, 44],
  },
  {
    key: 'acct_8',
    label: 'fieldnote',
    ...
    delta: 3.3,
    formattedDelta: '$3.30',
    sparklinePoints: [26, 27, 27, 28, 29, 29, 30, 30],
  },
  {
    key: 'acct_9',
    label: 'delta-forge',
    value: 18.6,
    formattedValue: '$18.60',
    delta: 0.4,
    formattedDelta: '$0.40',
    sparklinePoints: [18, 18, 18, 18, 18, 18, 18, 18],
  },
  {
    key: 'acct_10',
    label: 'ember-cloud',
    ...
    delta: -0.2,
    formattedDelta: '$0.20',
    sparklinePoints: [9, 9, 9, 9, 9, 9, 9, 9],
  },
];
...
export const rankedRowsSentinelUsers: RankedSeriesRow[] = [
  {
    ...
    value: 22.4,
    formattedValue: '$22.40',
    sparklinePoints: [2, 3, 4, 5, 4, 3, 5, 6],
  },
  {
    ...
    value: 6.1,
    formattedValue: '$6.10',
    sparklinePoints: [1, 1, 1, 1, 1, 1, 0.6, 0.5],
  },
  {
