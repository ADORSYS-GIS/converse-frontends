 ...
 * `SpendDashboard`, `LatencyDashboard` and `SpendShareSection` cannot drift on the wording
 * (console-ui skill "empty states are inline status lines" — never a fabricated `0`, never
 * rendered blank).
 *
